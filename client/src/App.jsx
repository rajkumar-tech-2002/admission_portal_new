...
function App() {
  return (
    <Router basename="/admission_portal">
      <ToastProvider />
      <Routes>
        ...
        >
          ...
          />
          <Route
            path="secretary-report/report-1"
            element={
              <RoleRoute allowedRoles={["ao"]}>
          ...
          />
          <Route
            path="secretary-report/report-2"
            element={
              <RoleRoute allowedRoles={["ao"]}>
                <AOCommunityReport />
              </RoleRoute>
          ...
          />
          <Route
            path="secretary-report/report-3"
            element={
              <RoleRoute allowedRoles={["ao"]}>
          ...
          />
          <Route
            path="reports/fees-originals-pg"
            element={
              <RoleRoute allowedRoles={["admin", "admission_team", "ao"]}>
          ...
          />
          <Route
            path="reports/certificate-count"
            element={
              <RoleRoute allowedRoles={["admin", "admission_team", "ao"]}>
          ...
          />
          <Route
            path="reports/certificate-count-pg"
            element={
              <RoleRoute allowedRoles={["admin", "admission_team", "ao"]}>
          ...
          />
          <Route
            path="reports/certificate-count-npc"
            element={
              <RoleRoute allowedRoles={["admin", "admission_team", "ao"]}>
          ...
          />
          <Route
            path="reports/fees-originals-npc"
            element={
              <RoleRoute allowedRoles={["admin", "admission_team", "ao"]}>
                ...
                <MasterManagementPage
                  ...
                  fields={[
                    ...
                    },
                    {
                      ...
                      label: "Program",
                      type: "select",
                      options: ["B.E", "B.Tech", "M.E", "Nothing"],
                      required: false,
                    },
                    {
                      name: "department",
            ...
            element={
              <RoleRoute allowedRoles={["admin"]}>
                <MasterManagementPage
                  ...
                  fields={[
                    { name: "study", label: "Study Level", required: true },
                  ]}
                />
              </RoleRoute>
            }
          ...
          <Route
            path="master/admission-statuses"
            element={
              <RoleRoute allowedRoles={["admin"]}>
                <MasterManagementPage
              ...
              <RoleRoute allowedRoles={["admin"]}>
                <MasterManagementPage
                  ...
                  fields={[
                    {
                      name: "date_count",
                      label: "Days to Archive",
                      type: "number",
                      required: true,
                    },
                    {
                      name: "archive_status",
                      label: "Statuses to Archive",
                      type: "checkbox-group",
                      optionsKey: "admissionStatuses",
                      required: true,
                    },
                    {
                      name: "reference_way",
                      label: "Reference Ways to Archive",
                      type: "checkbox-group",
                      options: ["Normal", "Direct"],
                      required: true,
                    },
                ...
                <MasterManagementPage
                  ...
                  fields={[
                    ...
                    },
                    {
                      ...
                      dependsOn: "staff_institution",
                    },
                    {
                      name: "staff_programme",
                      label: "Programme",
                      type: "auto-filled",
                      autoFillFrom: "staff_department",
                      autoFillSource: "program",
                    },
                    {
                      name: "staff_programme_type",
            ...
            element={
              <RoleRoute allowedRoles={["admin"]}>
                <MasterManagementPage
                  ...
                  columns={[
                    { key: "school_type_name", label: "School Type Name" },
                  ]}
                  fields={[
                    {
            ...
            element={
              <RoleRoute allowedRoles={["admin"]}>
                <MasterManagementPage
                  ...
                  columns={[
                    {
                      key: "admission_year_name",
                      label: "Admission Year Name",
                    },
                  ]}
                  fields={[
                    {
            ...
            element={
              <RoleRoute allowedRoles={["admin"]}>
                <MasterManagementPage
                  ...
                  columns={[
                    { key: "concession_type", label: "Concession Type" },
                  ]}
                  fields={[
                    {
