...
const AOReferenceWiseReport = () => {
    ...
    const handleExportRecords = () => {
        ...
        const exportData = groupedRows.map(r => {
            let rowData = {
                ...
                'NEC Discontinue': r.NEC_Discontinue || 0,
                'NCT Admitted': r.NCT_Admitted || 0,
                'NCT Discontinue': r.NCT_Discontinue || 0,
                'NPC Admitted': r.NPC_Admitted || 0,
                'NPC Discontinue': r.NPC_Discontinue || 0,
                // 'Total Admitted': r.Total_Admitted || 0,
                // 'Total Discontinue': r.Total_Discontinue || 0,
    ...
    const numCols = ['NEC_Admitted', 'NEC_Discontinue', 'NCT_Admitted', 'NCT_Discontinue', 'NPC_Admitted', 'NPC_Discontinue'];
    // 'Total_Admitted', 'Total_Discontinue', 'Total_Count'
    const numHeaders = ['NEC Admitted', 'NEC Discontinue', 'NCT Admitted', 'NCT Discontinue', 'NPC Admitted', 'NPC Discontinue'];
    // 'Total Admitted', 'Total Discontinue', 'Total Count'
