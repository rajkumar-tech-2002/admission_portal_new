                        ...
                        <tbody>
                            ...
                            {!loading && filteredRecords.length > 0 && (
                                <tr className={dashStyles.subtotalRow}>
                                    ...
                                    <td className={dashStyles.subtotalVal}>SUM={summary.staffCount}</td>
                                    <td className={dashStyles.subtotalVal}>SUM={summary.target}</td>
                                    <td className={dashStyles.subtotalVal}>SUM={summary.entryCount}</td>
                                    <td className={dashStyles.subtotalVal}>SUM={summary.balance}</td>
                                    <td className={dashStyles.subtotalVal}>{summaryPercentage}%</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
