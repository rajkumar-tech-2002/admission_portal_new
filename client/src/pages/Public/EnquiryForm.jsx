...
const EnquiryForm = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "selected_dept") {
      ...
      setFormData({
        ...formData,
        [name]: value,
        selected_course: selectedText,
        selected_ug_pg: autoUgPg,
      });
    } else if (name === "reference_type") {
      const selectedRef = masterData.referenceTypes.find(
        (r) => r.reference_type === value,
      );
      setFormData({
        ...formData,
        [name]: value,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await apiService.post("/records", payload);
      ...
      if (response.data.success) {
        ...
        if (formData.reference_email) {
          ...
          try {
            await apiService.post(`/records/${id}/public-email`, emailPayload);
          } catch (err) {
      ...
      <div className={styles.pageContainer}>
        <div className={styles.header}>
          ...
          <p className={styles.textInfo}>
            Status default: enquiry • Auto delete after 3 days if not confirmed
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div className={styles.grid}>
                <div className="form-group">
                  <label className="form-label">
                    12th Registration No{" "}
                    <span className={styles.required}>*</span>
                  </label>
                  <input
                    type="text"
                    name="reg_no_12th"
                    value={formData.reg_no_12th}
                ...
                <div className="form-group">
                  ...
                  <input
                    type="tel"
                    name="std_whatsapp_no"
                    value={formData.std_whatsapp_no}
                    onChange={handleChange}
                    className="form-input"
                    maxLength="10"
                  />
                ...
                <div className="form-group">
                  <label className="form-label">
                    Aadhaar No <span className={styles.required}>*</span>
                  </label>
                  <input
                    type="text"
                    name="aadhaar_no"
            ...
            <div className={styles.formSection}>
              ...
              <div className={styles.grid}>
                <div className="form-group">
                  <label className="form-label">
                    Last Studied School / College
                  </label>
                  <input
                    type="text"
                    name="last_studied_name"
                    value={formData.last_studied_name}
                    onChange={handleChange}
                    className="form-input"
                  />
                </div>
                <div className="form-group">
                  ...
                  >
                    ...
                    {masterData.studies.map((s) => (
                      <option key={s.id} value={s.study}>
                        {s.study}
                      </option>
                    ))}
                  </select>
            ...
            <div className={styles.formSection}>
              ...
              <div className={styles.grid}>
                <div className="form-group">
                  ...
                  >
                    ...
                    {masterData.departments
                      .filter((d) =>
                        formData.selected_ug_pg
                          ? d.type === formData.selected_ug_pg
                          : true,
                      )
                      .map((d) => {
                        const parts = [];
                        ...
                        return (
                          <option key={d.id} value={displayText}>
                            {displayText}
                          </option>
                        );
                      })}
                ...
                <div className="form-group">
                  <label className="form-label">
                    Selected UG/PG <span className={styles.required}>*</span>
                  </label>
                  <select
                    name="selected_ug_pg"
                    value={formData.selected_ug_pg}
                    onChange={handleChange}
                    className="form-select"
                    required
                  >
                ...
                <div className="form-group">
                  ...
                  >
                    ...
                    {masterData.admissionTypes.map((t) => (
                      <option key={t.id} value={t.admission_type}>
                        {t.admission_type}
                      </option>
                    ))}
                  </select>
              ...
              <div className={styles.grid}>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    value={formData.reference_contact_no}
                    onChange={handleChange}
                    className="form-input"
                    maxLength="10"
                  />
                ...
                <div className="form-group">
                  <label className="form-label">
                    Reference Email <span className={styles.required}>*</span>
                  </label>
                  <input
                    type="email"
      ...
      {isGenerating && (
        ...
        >
          <div id="report-capture-area" style={{ background: "#fff" }}>
            <RecordReport data={pdfRecordData || formData} standalone={true} />
          </div>
        </div>
      )}
    </div>
