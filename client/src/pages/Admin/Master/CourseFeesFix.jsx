...
const CourseFeesFix = () => {
    ...
    const handleSave = async (e) => {
        ...
        try {
            if (formData.id) {
                // Update
                const res = await apiService.put(`/master/course_fee_structure/${formData.id}`, formData);
                if (res.data.success) {
                        ...
                        <form onSubmit={handleSave} className={`${styles.modalForm} ${styles.modalFormGrid}`}>
                            <div className={styles.formGroup}>
                                ...
                                <select 
                                    ...
                                    value={formData.programme && formData.department ? `${formData.programme} - ${formData.department}` : ''}
