...
const MasterManagementPage = ({ title, tableType, columns, fields }) => {
    ...
    const handleOpenModal = (item = null) => {
        ...
        if (item) {
            ...
            fields.forEach(f => {
                ...
                if (f.type === 'select' && f.options && f.options.includes('Nothing')) {
                    if (item[f.name] === null || item[f.name] === undefined || item[f.name] === '') {
                        initializedData[f.name] = 'Nothing';
                    }
                }
            });
            ...
            fields.forEach(f => {
                ...
                else if (f.type === 'select' && f.options && f.options.includes('Nothing')) initialData[f.name] = 'Nothing';
    ...
    const handleSubmit = async (e) => {
        ...
        fields.forEach(field => {
            ...
            if (field.type === 'select' && field.options && field.options.includes('Nothing') && value === 'Nothing') {
                value = null;
            }
